...
1. Log in to the app using the **email** of the account you wish to delete.
2. Send an email to **support@treestcorp.com** with the following details:
    - Subject: **Account Deletion Request**
    - Body: Reason for deletion or any additional explanation (optional)
3. After your request is verified, your account and related data will be deleted according to the policy below.
